...
Join Our [Group](https://t.me/Violet_Support) If You wanna Report Issue 🙂
...
*Managed With ❤️ By :* [Ihsan•イサン](https://t.me/RxyMX)
...
buttons = [
    [
        InlineKeyboardButton(
            text=" Add to Group ", url="t.me/VioletsRobot?startgroup=true"
        ),
   ]
]
    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                "https://telegra.ph/file/affc5b6e16d248d5bb00f.jpg",
                PM_START_TEXT,
